...
#    Updated: 2024/05/30 20:24:29 by mganchev         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(SRCDIR)/so_long_utils.c $(SRCDIR)/get_next_line.c $(SRCDIR)/get_next_line_utils.c \
$(SRCDIR)/map_file.c $(SRCDIR)/map_errors.c
...
$(OBJDIR)/map_file.o $(OBJDIR)/map_errors.o
